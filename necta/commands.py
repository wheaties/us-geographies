...
from necta.necta_cities import load_raw_necta_cities, necta_cities_setup
from necta.necta_combined import load_raw_necta_combined, necta_combined_setup
...
def run_necta(connection, year, root_folder=None, force=False):
    ...
    necta_cities_setup(connection, year, force)
    load_raw_necta_cities(connection, files.necta_cities, year, force)

    necta_combined_setup(connection, year, force)
